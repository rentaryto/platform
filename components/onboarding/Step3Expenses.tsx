...
export function Step3Expenses({ propertyId, onComplete, onBack }: Props) {
  ...
  const handleFrequency = (key: string, frequency: Frequency) => {
    setExpenses((prev) => ({
      ...prev,
      [key]: {
        ...prev[key],
          ...
          >
            <div className="flex items-start gap-3">
              <input
                ...
                className="h-4 w-4 rounded border-gray-300 accent-blue-600 mt-1"
              />
                  ...
                  <div className="space-y-3">
                    <div className="flex flex-col sm:flex-row gap-2">
                      ...
                      <Select
                        ...
                        onValueChange={(value: Frequency) => handleFrequency(key, value)}
                      >
